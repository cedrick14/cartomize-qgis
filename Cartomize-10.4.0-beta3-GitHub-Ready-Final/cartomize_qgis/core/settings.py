...
class CartomizeSettings:
    ...
    def load(cls) -> "CartomizeSettings":
        ...
        return cls(
            ...
            community_url=_validated_url(str(_setting_value(settings, "community_url", DEFAULT_COMMUNITY_URL))),
    ...
    def save(self) -> None:
        ...
        settings.setValue(f"{prefix}/community_url", _validated_url(self.community_url))
