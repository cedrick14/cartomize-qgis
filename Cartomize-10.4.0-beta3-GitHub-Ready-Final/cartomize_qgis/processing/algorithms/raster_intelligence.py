"""Algorithme Processing pour le diagnostic intelligent d'un raster."""
...
class RasterIntelligenceAlgorithm(QgsProcessingAlgorithm):
    ...
    def displayName(self):
        return "Analyser un raster avec Raster Intelligence"
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(
            QgsProcessingParameterFileDestination(
                self.REPORT, "Rapport Raster Intelligence", "Rapport JSON (*.json)"
            )
        )
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        diagnosis = RasterIntelligenceEngine().analyze(layer, deep=False)
